 ...
 */
final class Version20230901135038 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE owned_collection (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, status SMALLINT NOT NULL, UNIQUE INDEX UNIQ_4D02B46BA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE owned_collection_comics (owned_collection_id INT NOT NULL, comics_id INT NOT NULL, INDEX IDX_CF3186274C64EB2C (owned_collection_id), INDEX IDX_CF31862771AE76A2 (comics_id), PRIMARY KEY(owned_collection_id, comics_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_collection (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, status SMALLINT NOT NULL, UNIQUE INDEX UNIQ_5B2AA3DEA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE owned_collection ADD CONSTRAINT FK_4D02B46BA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE owned_collection_comics ADD CONSTRAINT FK_CF3186274C64EB2C FOREIGN KEY (owned_collection_id) REFERENCES owned_collection (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE owned_collection_comics ADD CONSTRAINT FK_CF31862771AE76A2 FOREIGN KEY (comics_id) REFERENCES comics (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE owned_collection DROP FOREIGN KEY FK_4D02B46BA76ED395');
        $this->addSql('ALTER TABLE owned_collection_comics DROP FOREIGN KEY FK_CF3186274C64EB2C');
        $this->addSql('ALTER TABLE owned_collection_comics DROP FOREIGN KEY FK_CF31862771AE76A2');
        ...
        $this->addSql('DROP TABLE owned_collection');
        $this->addSql('DROP TABLE owned_collection_comics');
