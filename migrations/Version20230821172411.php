 ...
 */
final class Version20230821172411 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_collection ADD user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_5B2AA3DEA76ED395 ON user_collection');
        $this->addSql('ALTER TABLE user_collection DROP user_id');
    }
}
